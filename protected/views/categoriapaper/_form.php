...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'CATP_NOMBRE'); ?>
		<?php echo $form->textField($model,'CATP_NOMBRE',array('size'=>45,'maxlength'=>45)); ?>
		<?php echo $form->error($model,'CATP_NOMBRE'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'CATP_DESCRIPCION'); ?>
		<?php echo $form->textField($model,'CATP_DESCRIPCION',array('size'=>60,'maxlength'=>500)); ?>
		<?php echo $form->error($model,'CATP_DESCRIPCION'); ?>
	</div>
