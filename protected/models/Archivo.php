 ...
 * @property string $ARC_CORREL
 * @property string $PUB_CORREL
 * @property string $ARC_FILE
 */
class Archivo extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('PUB_CORREL, ARC_FILE', 'required'),
			array('PUB_CORREL', 'length', 'max'=>10),
			array('ARC_FILE', 'length', 'max'=>100),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('ARC_CORREL, PUB_CORREL, ARC_FILE', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('ARC_CORREL',$this->ARC_CORREL,true);
		$criteria->compare('PUB_CORREL',$this->PUB_CORREL,true);
		$criteria->compare('ARC_FILE',$this->ARC_FILE,true);
