...
class Investigadores extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('PUB_CORREL, INV_NOMBRE, INV_APELLIDOPATERNO, INV_APELLIDOMATERNO, INV_ROLE', 'required'),
			...
			array('INV_CORREL, PUB_CORREL, INV_NOMBRE, INV_APELLIDOPATERNO, INV_APELLIDOMATERNO, INV_ROLE', 'safe', 'on'=>'search'),
		);
	}
